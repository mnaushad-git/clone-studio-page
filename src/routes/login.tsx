      ...
      <div className="relative bg-white rounded-2xl shadow-2xl w-full max-w-md p-10">
        ...
        {mode === "otp" && (
          <button
            ...
            className="absolute top-5 left-5 text-foreground hover:text-primary"
            aria-label="Back"
          >
        ...
        {mode === "otp" ? (
          <form className="mt-8 space-y-5" onSubmit={(e) => e.preventDefault()}>
            ...
            <button
              ...
              className="w-full bg-primary text-primary-foreground rounded-md py-3 font-semibold hover:opacity-90 transition disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Verify
            </button>

            <div className="text-center">
              <button type="button" className="text-sm text-foreground hover:text-primary underline-offset-2 hover:underline">
                Resend code
              </button>
            </div>
          </form>
